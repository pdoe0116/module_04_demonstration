...
#LECTURE SECTION 1
# Initialize File to None or null outside of try block so that it is accessible in try and final blocks
file = None
try:
      ...
      #print ("File doe not exist",e)
      logging.error("File doe not exist")
